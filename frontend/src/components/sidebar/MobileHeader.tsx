  ...
  return (
    <header className="md:hidden h-14 border-b border-[var(--border-subtle)] bg-[var(--bg-900)] px-4 flex items-center justify-between z-30 shrink-0 sticky top-0">
      ...
      <div className="flex items-center gap-2">
        <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-[var(--accent)] to-[var(--accent-dark)] flex items-center justify-center shadow-[var(--shadow-glow)] shrink-0">
