    ...
    <div className="flex h-full w-full flex-1 bg-[var(--bg-950)] relative overflow-hidden font-sans">
      ...
      <div className="flex min-w-0 flex-1 flex-col relative z-10 overflow-hidden w-full h-full">
        ...
        <div className="absolute top-4 right-4 z-20 flex items-center gap-2">
          <button onClick={() => setShowSidebar(true)} className="flex items-center gap-2 rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)]/80 backdrop-blur px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-[var(--text-primary)] transition-all hover:border-[var(--accent)] hover:shadow-glow active:scale-[0.98]">
            <Bot className="w-4 h-4 text-[var(--accent)]" /> History
          </button>
          <button onClick={handleNewChat} className="flex items-center gap-2 rounded-xl border border-[var(--border-subtle)] bg-[var(--accent)] text-[var(--bg-950)] backdrop-blur px-3 py-2 text-[10px] font-bold uppercase tracking-wider transition-all hover:shadow-[0_0_20px_rgba(var(--accent-rgb),0.4)] active:scale-[0.98]">
        ...
        {showSidebar && (
          <div className="absolute inset-0 z-50 flex">
            <div className="absolute inset-0 bg-black/50 backdrop-blur-sm transition-opacity" onClick={() => setShowSidebar(false)} />
            <div className="relative flex w-[320px] max-w-[80vw] flex-col border-r border-[var(--border-subtle)] bg-[var(--bg-950)] shadow-2xl h-full animate-in slide-in-from-left duration-300">
              <div className="flex items-center justify-between border-b border-[var(--border-subtle)] p-4">
                <h2 className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)]">Chat History</h2>
                <button onClick={() => setShowSidebar(false)} className="p-1 rounded-lg hover:bg-white/10 transition-colors">
                  <X className="w-4 h-4 text-[var(--text-muted)]" />
                </button>
              </div>
              <div className="p-4 shrink-0">
                <button onClick={() => { handleNewChat(); setShowSidebar(false); }} className="flex w-full items-center justify-center gap-2 rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)] py-2.5 text-[10px] font-bold uppercase tracking-wider text-[var(--text-primary)] transition-all hover:border-[var(--accent)] hover:shadow-glow active:scale-[0.98]">
